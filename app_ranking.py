...
def main():
    ...
    try:
        ...
        st.write("Loaded Google credentials")
        ...
        if st.session_state.has_submitted:
            ...
            def add_rankings_to_sheet(rankings):
                ...
                st.write("Rankings added to the Google Sheet")
